...
class _HUFkycpageState extends State<HUFkycpage> {
  ...
  hufapicall() async {
    ...
    FormData formdata = FormData.fromMap({
      ...
      "pan_card[]": panCardImagesList,
      "coparcenrs_aadhar_passport[]": coparcenrsaddharpassImagesList,
      "proof_of_address": multipartFiles[2],
      "bank_statement": multipartFiles[3],
      "passport_size_photo": multipartFiles[4],
      "copy_of_cml": multipartFiles[5],
