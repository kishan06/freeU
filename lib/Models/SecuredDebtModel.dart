class SecuredDebtModel {
  List<Data>? data;

  SecuredDebtModel({this.data});

  SecuredDebtModel.fromJson(Map<String, dynamic> json) {
    if (json['data'] != null) {
      data = <Data>[];
      json['data'].forEach((v) {
...
class Data {
  ...
  int? status;
  String? createdAt;
  SecuritizedDebtInstruments? securitizedDebtInstruments;

  Data({this.id, this.status, this.createdAt, this.securitizedDebtInstruments});

  Data.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    status = json['status'];
    createdAt = json['created_at'];
    securitizedDebtInstruments = json['securitized_debt_instruments'] != null
        ? new SecuritizedDebtInstruments.fromJson(
            json['securitized_debt_instruments'])
        : null;
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.securitizedDebtInstruments != null) {
      data['securitized_debt_instruments'] =
          this.securitizedDebtInstruments!.toJson();
    }
    return data;
  }
}

class SecuritizedDebtInstruments {
  int? id;
  int? productsId;
  String? slug;
  String? productName;
  ...
  SecuritizedDebtInstruments.fromJson(Map<String, dynamic> json) {
    id = json['id'];
