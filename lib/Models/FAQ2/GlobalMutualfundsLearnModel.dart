class GlobalMutualFundsLearnModel {
  String? status;
  int? code;
  List<Data>? data;

  GlobalMutualFundsLearnModel({this.status, this.code, this.data});

  GlobalMutualFundsLearnModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    code = json['code'];
    if (json['data'] != null) {
      data = <Data>[];
