class Alternative1AngelLearnModel {
  String? status;
  int? code;
  List<Data>? data;

  Alternative1AngelLearnModel({this.status, this.code, this.data});

  Alternative1AngelLearnModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    code = json['code'];
    if (json['data'] != null) {
      data = <Data>[];
