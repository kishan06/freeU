class GlobalCommerciallLearnModel {
  String? status;
  int? code;
  List<Data>? data;

  GlobalCommerciallLearnModel({this.status, this.code, this.data});

  GlobalCommerciallLearnModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    code = json['code'];
    if (json['data'] != null) {
      data = <Data>[];
