class GlobalResidentialLearnModel {
  String? status;
  int? code;
  List<Data>? data;

  GlobalResidentialLearnModel({this.status, this.code, this.data});

  GlobalResidentialLearnModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    code = json['code'];
    if (json['data'] != null) {
      data = <Data>[];
