class IndianResidentialLearnModel {
  String? status;
  int? code;
  List<Data>? data;

  IndianResidentialLearnModel({this.status, this.code, this.data});

  IndianResidentialLearnModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    code = json['code'];
    if (json['data'] != null) {
      data = <Data>[];
