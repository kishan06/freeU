class Alternative3HedgeLearnModel {
  String? status;
  int? code;
  List<Data>? data;

  Alternative3HedgeLearnModel({this.status, this.code, this.data});

  Alternative3HedgeLearnModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    code = json['code'];
    if (json['data'] != null) {
      data = <Data>[];
