class GetalternativelearnmoreModel {
  bool? invested;
  String? type;
  Data? data;

  GetalternativelearnmoreModel({this.invested, this.type, this.data});

  GetalternativelearnmoreModel.fromJson(Map<String, dynamic> json) {
