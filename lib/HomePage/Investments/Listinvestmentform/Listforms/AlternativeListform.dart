...
class AIFListSellForm extends StatefulWidget {
  const AIFListSellForm({super.key});

  @override
  State<AIFListSellForm> createState() => _AIFListSellFormState();
}

class _AIFListSellFormState extends State<AIFListSellForm> {
  ...
  Uploadata() async {
    ...
    final data = await Listinvestform().PostListSellalternativeform(updata);
