...
class FractionalRealEstateProperty2 extends StatefulWidget {
  const FractionalRealEstateProperty2({super.key});

  @override
  State<FractionalRealEstateProperty2> createState() =>
      _FractionalRealEstateProperty2State();
}

class _FractionalRealEstateProperty2State
    extends State<FractionalRealEstateProperty2> {
  int selectIndex = 0;
