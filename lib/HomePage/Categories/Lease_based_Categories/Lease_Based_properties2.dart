...
class LeaseBasedProperties2 extends StatefulWidget {
  const LeaseBasedProperties2({super.key});

  @override
  State<LeaseBasedProperties2> createState() => _LeaseBasedProperties2State();
}

class _LeaseBasedProperties2State extends State<LeaseBasedProperties2> {
