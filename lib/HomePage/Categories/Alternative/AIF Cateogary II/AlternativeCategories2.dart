...
class _AlternativeCategories2State extends State<AlternativeCategories2> {
            ...
            child: ListView.separated(
                itemBuilder: (context, index) {
                  return Secondalternative(
                    alternative2!.data![index].faqQuestion ?? "",
                    alternative2!.data![index].faqAnswer ?? "",
                  );
                },
                separatorBuilder: (context, index) {
                  return sizedBoxHeight(20.h);
                },
                itemCount: alternative2!.data!.length),
          ),
        ],
      ),
    );
  ...
  Widget Secondalternative(String question, String ans) {
    return Container(
