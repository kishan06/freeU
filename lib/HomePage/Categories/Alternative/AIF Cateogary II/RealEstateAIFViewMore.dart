...
class RealEstateAIFViewMore extends StatefulWidget {
  const RealEstateAIFViewMore({super.key});

  @override
  State<RealEstateAIFViewMore> createState() => _RealEstateAIFViewMoreState();
}
