...
class _RealEstateViewmoreProductsState
  ...
  void initState() {
    ...
    myfuture = PrivateRealestate().PrivateRealestateAPI();
    super.initState();
  }
...
class SecondTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return 
    privaterealestateObj!.data!.isEmpty ?
    ...
    ListView.separated(
      ...
      itemCount: privaterealestateObj!.data!.length,
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        Flexible(
                          child: Text(
                            privaterealestateObj!.data?[index]
                    ...
                    Row(
                      children: [
                        ...
                        Text(
                          // privaterealestateObj!.data?[index].alternativeInvestmentFund!.ca ?? "",
                          "12.7%",
                          style: TextStyle(
                              fontSize: 18.sp,
                              fontFamily: 'Poppins',
                    ...
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: OpenContainerWrappers(
                          openBuild: 
                          RealEstateDetails(
                            slug: privaterealestateObj!.data?[index].alternativeInvestmentFund!.slug ?? "",
                            ),
                          // realSlider[index]['View investment Route'],
                          closeBuild: SizedBox(
