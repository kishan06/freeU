...
class _PrivatePublicEquityViewMoreState
  ...
  @override
  void initState() {
    myfuture = FAQ2().Alternative3PrivInveinPublicEquiFund();
    super.initState();
  }
          ...
          Expanded(
            child: ListView.separated(
                itemBuilder: (context, index) {
                  return alternative3privpubequi(
                    alternati3privapubequilearn!.data![index].faqQuestion ?? "",
                    alternati3privapubequilearn!.data![index].faqAnswer ?? "",
                  );
                },
                separatorBuilder: (context, index) {
                  return sizedBoxHeight(20.h);
                },
                itemCount: alternati3privapubequilearn!.data!.length),
          ),
        ],
      ),
    );
  ...
  Widget alternative3privpubequi(String question, String ans) {
    return Container(
