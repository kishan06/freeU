...
class _HedgeViewMoreState extends State<HedgeViewMore> {
  ...
  @override
  void initState() {
    myfuture = FAQ2().Alternative3HedgeFund();
    super.initState();
  }
          ...
          Expanded(
            child: ListView.separated(
                itemBuilder: (context, index) {
                  return alternative3hedge(
                    alternati3hedgelearn!.data![index].faqQuestion ?? "",
                    alternati3hedgelearn!.data![index].faqAnswer ?? "",
                  );
                },
                separatorBuilder: (context, index) {
                  return sizedBoxHeight(20.h);
                },
                itemCount: alternati3hedgelearn!.data!.length),
          ),
        ],
      ),
    );
  ...
  Widget alternative3hedge(String question, String ans) {
    return Container(
