...
class _InfrastructureViewMoreState extends State<InfrastructureViewMore> {
  ...
  @override
  void initState() {
    myfuture = FAQ2().Alternative1Infrastructure();
    super.initState();
  }
          ...
          Expanded(
            child: ListView.separated(
                itemBuilder: (context, index) {
                  return alternative1infra(
                    alternati1infrastructurefunds!.data![index].faqQuestion ??
                        "",
                    alternati1infrastructurefunds!.data![index].faqAnswer ?? "",
                  );
                },
                separatorBuilder: (context, index) {
                  return sizedBoxHeight(20.h);
                },
                itemCount: alternati1infrastructurefunds!.data!.length),
          ),
        ],
      ),
    );
  ...
  Widget alternative1infra(String question, String ans) {
    return Container(
