...
import 'package:freeu/HomePage/Categories/Alternative/AIF%20Cateogary%20I/Infrastructure%20Fund/detailsinfrastructure.dart';
...
class _InfractureViewMoreProductState extends State<InfractureViewMoreProduct> {
  ...
  void initState() {
    ...
    myfuture = Alternative1().Infrastructurefund();
...
class SecondTab extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return infrastructureobj!.data!.isEmpty
        ...
        : ListView.separated(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                OpenContainerWrappers(
                                  openBuild: InfrastructureViewDetails(
                                      slug: infrastructureobj!.data![index]
            ...
            itemCount: infrastructureobj!.data!.length,
          );
  }
