...
import 'package:freeu/HomePage/Categories/IndianRealAssets/CommercialRealEstate/Commercialproducts/detailscommercial.dart';
...
import 'package:freeu/viewModel/IndianCommercialreal.dart';
import 'package:freeu/viewModel/Leasefinancing.dart';
import 'package:get/get.dart';
import 'package:lottie/lottie.dart';

class Commercialproductstab extends StatefulWidget {
  const Commercialproductstab({super.key});

  @override
  State<Commercialproductstab> createState() => _Commercialproductstab();
}

class _Commercialproductstab extends State<Commercialproductstab> {
  late Future myfuture;

  @override
  void initState() {
    myfuture = IndianCommercialreal().IndianCommercialrealAPI();
    super.initState();
  }
...
class SecondTab extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return Indiancommercialproducts!.data!.isEmpty
        ? _buildNoDataBody()
        : ListView.separated(
            ...
            itemCount: Indiancommercialproducts!.data!.length,
                          ...
                          Padding(
                            ...
                            child: Row(
                              children: [
                                Flexible(
                                  child: Text(
                                    Indiancommercialproducts!.data?[index]
                          ...
                          Padding(
                            ...
                            child: Container(
                              ...
                              child: OpenContainerWrappers(
                                openBuild: CommercialDetails(
                                  slug: Indiancommercialproducts!
