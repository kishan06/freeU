...
import 'package:freeu/HomePage/Categories/IndianRealAssets/IndustrialRealEstate/Industrialproducts/detailsindustrial.dart';
...
import 'package:freeu/ViewModel/IndianIndustrialproductsdata.dart';
import 'package:freeu/ViewModel/Leasefinancing.dart';
import 'package:get/get.dart';
import 'package:lottie/lottie.dart';

class Industrialproductstab extends StatefulWidget {
  const Industrialproductstab({super.key});

  @override
  State<Industrialproductstab> createState() => _Industrialproductstab();
}

class _Industrialproductstab extends State<Industrialproductstab> {
  late Future myfuture;

  @override
  void initState() {
   myfuture = IndianIndustrialreal().IndianIndustrialrealAPI();
    super.initState();
  }
...
class SecondTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return
    Indianindustrialproducts!.data!.isEmpty ?
    _buildNoDataBody()
     : ListView.separated(
          ...
          itemCount: Indianindustrialproducts!.data!.length,
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      Flexible(
                        child: Text(
                          Indianindustrialproducts!.data?[index].realEstate!.propertyName ?? "",
                          // "Warehouse/Godown For Sale in Andheri East, Mumbai",
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Text(
                          Indianindustrialproducts!.data?[index].realEstate!.projectType ?? "NA",
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Text(
                          Indianindustrialproducts!.data?[index].realEstate!.transactionType ?? "NA",
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    child: OpenContainerWrappers(
                      openBuild: IndustrialDetails(
                        slug: Indianindustrialproducts!.data?[index].realEstate!.slug ?? "",
                      ),
                      // LeaseViewInvestment(
