...
class ResidentialLearnmore extends StatefulWidget {
  const ResidentialLearnmore({super.key});

  @override
  State<ResidentialLearnmore> createState() => _ResidentialLearnmoreState();
}

class _ResidentialLearnmoreState extends State<ResidentialLearnmore> {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: Padding(
        ...
        child: CustomNextButton(
          ...
          ontap: () {
            Get.toNamed("/residentialproducts");
          },
        ),
      ),
      body: 
