...
class _GlobalCommercialDetailsState extends State<GlobalCommercialDetails> {
  ...
  Widget _buildBody(context) {
    ...
    if (GlobalCommercialdetailsobj!.data?.photos?.isNotEmpty ?? false) {
      return Column(
        children: [
          CarouselSlider.builder(
            carouselController: carouselController,
            itemCount: GlobalCommercialdetailsobj!.data?.photos?.length ?? 0,
            itemBuilder: (context, index, realIndex) {
              String? photoUrl =
                  GlobalCommercialdetailsobj!.data?.photos?[index].data;
          ...
          Row(
            ...
            children: List.generate(
              GlobalCommercialdetailsobj!.data?.photos?.length ?? 0,
