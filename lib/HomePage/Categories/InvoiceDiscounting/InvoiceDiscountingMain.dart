...
class InvoiceDiscountingMain extends StatefulWidget {
  ...
  @override
  State<InvoiceDiscountingMain> createState() => _InvoiceDiscountingState();
}

class _InvoiceDiscountingState extends State<InvoiceDiscountingMain> {
