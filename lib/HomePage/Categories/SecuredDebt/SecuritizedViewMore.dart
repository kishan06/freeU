...
String a = "Securitized Debt Instrument";
...
class _SecuritizedViewMoreState extends State<SecuritizedViewMore> {
  ...
  @override
  void initState() {
    myfuture = FAQ().securitizeddebtApi();
    super.initState();
  }
          ...
          Expanded(
            child: ListView.separated(
                itemBuilder: (context, index) {
                  return fracReal1(
                    secfaq!.data![index].faqQuestion ?? "",
                    secfaq!.data![index].faqAnswer ?? "",
                  );
                },
                separatorBuilder: (context, index) {
                  return sizedBoxHeight(20.h);
                },
                itemCount: secfaq!.data!.length),
          ),
        ],
      ),
    );
