...
class EcahrgedUpInvestNow extends StatefulWidget {
  const EcahrgedUpInvestNow({super.key});

  @override
  State<EcahrgedUpInvestNow> createState() => _EcahrgedUpInvestNowState();
}

class _EcahrgedUpInvestNowState extends State<EcahrgedUpInvestNow> {
  ...
  List ProductDetails = [
    {
      ...
      "Tenure": '15 Months',
      "Total Issue Size": '3 CR',
      "Interest Payout": 'Monthly',
      "Principal Payout": 'Monthly',
      "Expected Return": '~19% IRR',
      "Collateral & Cover Multiple": 'Secured NCDs – 1.5x Cover of Loan',
    },
  ];
