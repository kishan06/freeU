...
import 'package:freeu/viewModel/Highyieldbonds.dart';
...
class _HighyieldproductstabState extends State<Highyieldproductstab> {
  ...
  @override
  void initState() {
    myfuture = Highyieldbondsproducts().HighyieldbondsproductsAPI();
    super.initState();
  }
...
class SecondTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return 
    Highyieldbondsproductsobj!.data!.isEmpty ?
_buildNoDataBody(context)
 ...
 ListView.separated(
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Text(
                                Highyieldbondsproductsobj!.data![index].bonds!
                                        .minimumInvestment ??
                                    "NA",
                                // "10 Years",
                                style: TextStyle(
                          ...
                          OpenContainerWrappers(
                            openBuild:
                             HighyieldDetails(
                              slug: Highyieldbondsproductsobj!.data?[index].bonds!.slug ?? "",
                             ),
      ...
      itemCount: Highyieldbondsproductsobj!.data!.length,
    );
  }
