...
class HighyieldBondsLearnmore extends StatefulWidget {
  ...
  @override
  State<HighyieldBondsLearnmore> createState() => _HighyieldBondsLearnmoreState();
}
            ...
            Expanded(
              ...
              child: Column(
                children: [
                  sizedBoxHeight(20.h),
                  faqAccod(
                    title: 'Introduction to Sovereign Government Bonds',
                    content:
                        "As per SEBI Regulations Sovereign Government Bonds are Bonds that invests in early-stage startups, social ventures, SMEs, infrastructure startups, or other sectors or areas which the government considers socially or economically desirable. It includes investments such as venture capital funds, SME Funds, social venture funds, infrastructure funds, etc. "
                        "\n\nSovereign Government Bonds are the most popular among investors. These are investments in small, or medium enterprises, or start-ups that have high-growth potential, and are socially and economically viable. These usually have the potential to grow the economy and create jobs, and hence Sovereign Bonds are encouraged and promoted by the government and are extremely valuable to start-ups in our country.",
                  ),
                  sizedBoxHeight(20.h),
                  faqAccod(
                    title: 'Assets under Sovereign Government Bonds',
                    content:
