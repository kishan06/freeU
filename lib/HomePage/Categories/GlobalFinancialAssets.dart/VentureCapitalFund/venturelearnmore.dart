...
class VenturecapitalLearnmore extends StatefulWidget {
  const VenturecapitalLearnmore({super.key});

  @override
  State<VenturecapitalLearnmore> createState() =>
      _VenturecapitalLearnmoreState();
}

class _VenturecapitalLearnmoreState extends State<VenturecapitalLearnmore> {
...
For HNIs who are looking to diversify their portfolios and increase long-term returns on their investments while willing to take a considerable risk, Bonds seem like decent investment alternatives. But for those who can take low to high risk, mutual funds are the way to go. The decision between alternative investment funds and mutual funds should be based on your investment objectives, available capital, and long-term intentions.
 '''
    ...
    {
      "question":
          "Can an Bonds accept investments from more than one investor?",
      "ans":
  ...
  @override
  void initState() {
    myfuture = FAQ2().Globalventurecapitallearnmore();
    super.initState();
  }
    ...
    return Scaffold(
      ...
      bottomNavigationBar: Padding(
        ...
        child: CustomNextButton(
          text: 'View Capital Assets',
          ontap: () {
            Get.toNamed("/venturecapitalproducts");
          },
        ),
      ),
      body: 
          ...
          Expanded(
            child: ListView.separated(
                itemBuilder: (context, index) {
                  return globalventure(
                    globalventurecapitalmore!.data![index].faqQuestion ?? "",
                    globalventurecapitalmore!.data![index].faqAnswer ?? "",
                  );
                ...
                itemCount: globalventurecapitalmore!.data!.length),
          ),
        ],
      ),
    );
  ...
  Widget globalventure(String question, String ans) {
    return Container(
