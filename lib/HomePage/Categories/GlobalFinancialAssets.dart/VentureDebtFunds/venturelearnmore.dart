...
class VentureDebtLearnmore extends StatefulWidget {
  const VentureDebtLearnmore({super.key});

  @override
  State<VentureDebtLearnmore> createState() => _VentureDebtLearnmoreState();
}

class _VentureDebtLearnmoreState extends State<VentureDebtLearnmore> {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: Padding(
        ...
        child: CustomNextButton(
          text: 'View Venture Debt',
          ontap: () {
            Get.toNamed("/venturedebtproducts");
          },
        ),
      ),
      body: Padding(
