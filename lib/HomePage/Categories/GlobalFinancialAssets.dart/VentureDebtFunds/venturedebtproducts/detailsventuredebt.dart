...
class VentureDebtDetails extends StatefulWidget {
  // final int pageIndex;
  // final String slug;
  ...
  @override
  State<VentureDebtDetails> createState() => _VentureDebtDetailsState();
}

class _VentureDebtDetailsState extends State<VentureDebtDetails> {
