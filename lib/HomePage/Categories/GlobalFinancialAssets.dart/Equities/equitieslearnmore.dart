...
class EquitiesLearnmore extends StatefulWidget {
  const EquitiesLearnmore({super.key});

  @override
  State<EquitiesLearnmore> createState() => _EquitiesLearnmoreState();
}

class _EquitiesLearnmoreState extends State<EquitiesLearnmore> {
...
For HNIs who are looking to diversify their portfolios and increase long-term returns on their investments while willing to take a considerable risk, Bonds seem like decent investment alternatives. But for those who can take low to high risk, mutual funds are the way to go. The decision between alternative investment funds and mutual funds should be based on your investment objectives, available capital, and long-term intentions.
 '''
    ...
    return Scaffold(
      ...
      bottomNavigationBar: Padding(
        ...
        child: CustomNextButton(
          text: 'View Equities Assets',
          ontap: () {
            Get.toNamed("/equitiesproduct");
          },
        ),
      ),
      body: FutureBuilder(
      ...
      child: Column(
        ...
        children: [
          ...
          Expanded(
            child: ListView.separated(
                itemBuilder: (context, index) {
                  return globalequitieslearn(
                    globalequitieslearnmore!.data![index].faqQuestion ?? "",
                    globalequitieslearnmore!.data![index].faqAnswer ?? "",
                  );
                },
                separatorBuilder: (context, index) {
                  return sizedBoxHeight(20.h);
                },
                itemCount: globalequitieslearnmore!.data!.length),
          ),
        ],
      ),
    );
  ...
  Widget globalequitieslearn(String question, String ans) {
    return Container(
