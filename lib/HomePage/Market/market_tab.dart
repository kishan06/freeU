...
class _MarketTabState extends State<MarketTab> {
  ...
  Future<void> _loadResources(bool reload) async {
    await Marketplace().Spotlightinvest();
    await Marketplace().Featuredinvest();
    await Marketplace().Nonfeaturedinvest();
    // await FormMarketplace().Getform();
    await Sellinvestment().GetSellform();
  }
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          children: [
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Text(
                                    ...
                                    spotlightinve!.data!.expectedSale
                                        .toString(),
                                    style: TextStyle(
                                      fontSize: 20.sp,
                                      fontWeight: FontWeight.w500,
                            ...
                            Padding(
                              padding:
                                  EdgeInsets.fromLTRB(16.w, 5.h, 16.w, 10.h),
                              child: Container(
                                height: 50.h,
                                  ...
                                  Row(
                                    children: investmentData
                                      ...
                                      return OpenContainerWrappers(
                                        closeBuild: fractionalCard(
                                          title:
                                              investmentDetails.propertyName ??
                                                  "NA",
                                          text1: investmentDetails
                                                  .propertyAddress ??
                                              "NA",
                                          text2: investmentDetails.assetType ??
                                              "NA",
                                          text3: investmentDetails
                                                  .fractionalRealEstatePlatform ??
                                              "NA",
                                      ...
                                      return OpenContainerWrappers(
                                        closeBuild: alternativeCard(
                                          title: investmentDetails
                                              ...
                                              "NA",
                                          text1:
                                              investmentDetails.fundCategory ??
                                                  "NA",
                                  ...
                                  Row(
                                    children: investmentData.otherProducts!
                                      ...
                                      return OpenContainerWrappers(
                                        closeBuild: otherproductsCard(
                                          title:
                                              investmentDetails.securityName ??
                                                  "NA",
                                          text1: investmentDetails
                                                  .productCategory ??
                                              "NA",
                ...
                children: [
                  Row(
                    ...
                    children: [
                      SizedBox(
                          width: 200.w,
                          child: text20Black("Other Investments")),
                      InkWell(
                          onTap: () {
                            Get.toNamed("/EntryPoint",
                                arguments: 1, preventDuplicates: false);
