...
class OtherSellForm extends StatefulWidget {
  const OtherSellForm({super.key});

  @override
  State<OtherSellForm> createState() => _OtherSellFormState();
}

class _OtherSellFormState extends State<OtherSellForm> {
  ...
  Uploadata() async {
    ...
    final data = await Sellinvestment().PostSellothersform(updata);
