...
class FracionalSellForm extends StatefulWidget {
  const FracionalSellForm({super.key});

  @override
  State<FracionalSellForm> createState() => _FracionalSellFormState();
}

class _FracionalSellFormState extends State<FracionalSellForm> {
  ...
  Uploadata() async {
    ...
    final data = await Sellinvestment().PostSellfractionalform(updata);
