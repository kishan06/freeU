class ApiUrls {
  ...
  static const Leasefinancingdetails =
      "${baseUrl}lease-based-financing-single-data";
  ...
  static const VentureCapital = "${baseUrl}venture-capital-data";
  static const VentureCapitalDetails = "${baseUrl}venture-capital-single-data";

  static const AngelFund = "${baseUrl}angel-fund-data";
  static const AngelFundDetails = "${baseUrl}angel-fund-single-data";

  static const HedgeFund = "${baseUrl}hedge-fund-data";
